...
BEGIN
    ...
    -- Тест к уроку 1
    INSERT INTO final_tests (course_program_id, title, questions_count, is_active) VALUES
    (v_program_id, 'Тестовые задания к Уроку 1', 10, true);
    ...
    -- Тест к уроку 2
    INSERT INTO final_tests (course_program_id, title, questions_count, is_active) VALUES
    (v_program_id, 'Тестовые задания к Уроку 2', 20, true);
    ...
    -- Тест к уроку 3
    INSERT INTO final_tests (course_program_id, title, questions_count, is_active) VALUES
    (v_program_id, 'Тестовые задания к Уроку 3', 15, true);
    ...
    -- Тест к уроку 4
    INSERT INTO final_tests (course_program_id, title, questions_count, is_active) VALUES
    (v_program_id, 'Тестовые задания к Уроку 4', 10, true);
