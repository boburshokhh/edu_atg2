...
class Command(BaseCommand):
    help = "Apply incremental schema for course program topic files (safe/idempotent)."

    def add_arguments(self, parser):
        parser.add_argument(
            "--schema-file",
            default="migrations/course_program_topic_files.sql",
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Course program topic files schema applied."))
