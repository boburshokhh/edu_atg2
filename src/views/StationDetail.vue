    ...
    <div class="bg-gray-50">
      <div class="page-container section-padding">
        ...
        <div class="max-w-7xl mx-auto mb-12">
          <!-- Заголовок секции -->
          <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Техническая информация</h2>
          ...
          <div class="bg-white rounded-2xl shadow-xl border-2 border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-6">
              <div class="flex items-center justify-between">
                <div>
                  <div class="text-sm opacity-90 mb-1">СП ООО «ASIA TRANS GAS»</div>
                  <h3 class="text-2xl font-bold">Паспорт компрессорной станции</h3>
                </div>
                <div class="text-right">
                  <div class="text-sm opacity-90">Регистрационный номер</div>
                  <div class="text-xl font-bold">{{ station?.shortName }}-2024</div>
                </div>
              </div>
            </div>
            ...
            <div class="p-8 md:p-12">
              ...
              <section class="mb-10">
                ...
                <div v-if="station?.gasSupplySources" class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border-2 border-blue-200">
                    <div class="flex items-center mb-4">
                      ...
                      <h5 class="text-lg font-bold text-gray-900">Источники поставки газа</h5>
                    </div>
                    <ul class="space-y-3">
                      <li v-for="(source, idx) in station.gasSupplySources" :key="idx" class="flex items-start">
                  ...
                  <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-xl p-6 border-2 border-amber-200">
                    <div class="flex items-center mb-4">
                      ...
                      <h5 class="text-lg font-bold text-gray-900">Характеристики магистрали</h5>
                    </div>
                    <div class="space-y-3">
                      <div v-if="station.pipelineDiameter" class="flex items-start">
                        ...
                        <div>
                          <div class="text-xs text-gray-600 font-medium">Диаметр трубопровода</div>
                          <div class="text-sm font-bold text-gray-900">{{ station.pipelineDiameter }}</div>
                        </div>
                      </div>
                      <div v-if="station.distanceFromBorder" class="flex items-start">
                        <svg class="w-5 h-5 text-amber-600 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd" />
                        </svg>
                        <div>
                          <div class="text-xs text-gray-600 font-medium">Расположение</div>
                          <div class="text-sm font-bold text-gray-900">{{ station.distanceFromBorder }}</div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <section class="mb-10" v-if="station?.equipment && station.equipment.length > 0">
                <h4 class="text-xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-blue-600">
                  ...
                  <table class="w-full border-collapse bg-white rounded-lg shadow-lg">
                    <thead>
                      <tr class="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                        <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">№</th>
                        <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">Наименование</th>
                        <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">Тип/Модель</th>
                        <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">Производитель</th>
                        <th class="border border-blue-500 px-4 py-4 text-center text-sm font-bold">Кол-во</th>
                        <th class="border border-blue-500 px-4 py-4 text-center text-sm font-bold">Мощность</th>
                        <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">Описание</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr v-for="(equipment, index) in station?.equipment" :key="index" 
                ...
                <div class="md:hidden space-y-4">
                  <div v-for="(equipment, index) in station?.equipment" :key="index"
                    ...
                    <div class="flex items-center justify-between mb-3 pb-3 border-b border-gray-200">
                      <div class="flex items-center">
                        ...
                        <h5 class="font-bold text-gray-900 text-base">{{ equipment.name }}</h5>
                      </div>
                    </div>
                    ...
                    <div class="space-y-3">
                      <div class="flex items-center">
                        <svg class="w-4 h-4 text-blue-600 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div v-if="equipment.power" class="flex items-center">
                        <svg class="w-4 h-4 text-amber-600 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div v-if="equipment.description" class="mt-3 pt-3 border-t border-gray-100">
                        <div class="flex items-start">
                          ...
                          <div>
                            ...
                            <p class="text-gray-700 text-sm italic mt-1">{{ equipment.description }}</p>
                          </div>
                        </div>
                      </div>
                    </div>
               ...
               <section class="mb-10" v-if="station?.specifications && station.specifications.length > 0">
                 <h4 class="text-xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-blue-600">
                 ...
                 <div class="hidden md:block overflow-x-auto">
                   <table class="w-full border-collapse bg-white rounded-lg shadow-lg">
                     <thead>
                       <tr class="bg-gradient-to-r from-blue-600 to-blue-700 text-white">
                         <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">Параметр</th>
                         <th class="border border-blue-500 px-4 py-4 text-center text-sm font-bold">Значение</th>
                         <th class="border border-blue-500 px-4 py-4 text-center text-sm font-bold">Единица</th>
                         <th class="border border-blue-500 px-4 py-4 text-left text-sm font-bold">Описание</th>
                       </tr>
                     </thead>
                     <tbody>
                       <tr v-for="(spec, index) in station?.specifications" :key="index" 
                           class="hover:bg-blue-50 transition-colors duration-200">
                         <td class="border border-gray-300 px-4 py-4 text-sm font-semibold text-gray-900">
                           {{ spec.category }}
                         </td>
                 ...
                 <!-- Мобильные карточки (показаны только на мобильных) -->
                 <div class="md:hidden space-y-4">
                   <div v-for="(spec, index) in station?.specifications" :key="index"
                        class="bg-white rounded-lg shadow-lg border border-gray-200 p-4 hover:shadow-xl transition-shadow duration-300">
                     <!-- Заголовок карточки -->
                     <div class="flex items-center justify-between mb-3 pb-3 border-b border-gray-200">
                       <div class="flex items-center">
                         ...
                         <h5 class="font-bold text-gray-900 text-base">{{ spec.category }}</h5>
                       </div>
                     </div>
                     ...
                     <div class="space-y-3">
                       ...
                       <div class="mt-3 pt-3 border-t border-gray-100">
                         <div class="flex items-start">
                           ...
                           <div>
                             <span class="text-gray-600 text-xs font-medium">Описание:</span>
                             <p class="text-gray-700 text-sm mt-1">{{ spec.description }}</p>
                           </div>
                         </div>
                       </div>
                     </div>
              ...
              <section class="mb-10" v-if="station?.id === 1">
                <h4 class="text-xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-blue-600">
                  4. ТЕХНОЛОГИЧЕСКИЕ ПРОЦЕССЫ
                </h4>
                
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 mb-6">
                  <h5 class="text-lg font-semibold text-gray-900 mb-4">Основные технологические операции:</h5>
                  <div class="grid md:grid-cols-2 gap-6">
                    <div class="space-y-3">
                      <div class="flex items-start">
                        <div class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">1</div>
                        <div>
                          <span class="font-semibold text-gray-900">Прием газа</span>
                          <p class="text-gray-600 text-sm">От ТКС и ТАС по трубопроводу Ø1067 мм</p>
                        </div>
                      </div>
                      <div class="flex items-start">
                        <div class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">2</div>
                        <div>
                          <span class="font-semibold text-gray-900">Анализ параметров</span>
                          <p class="text-gray-600 text-sm">Физико-химические характеристики газа</p>
                        </div>
                      </div>
                      <div class="flex items-start">
                        <div class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">3</div>
                        <div>
                          <span class="font-semibold text-gray-900">Очистка газа</span>
                          <p class="text-gray-600 text-sm">8 линий очистки (5 для нитки А, 3 для нитки В)</p>
                        </div>
                      </div>
                    </div>
                    <div class="space-y-3">
                      <div class="flex items-start">
                        <div class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">4</div>
                        <div>
                          <span class="font-semibold text-gray-900">Измерение объема</span>
                          <p class="text-gray-600 text-sm">9 линий узла замера газа (DANIEL 3400)</p>
                        </div>
                      </div>
                      <div class="flex items-start">
                        <div class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">5</div>
                        <div>
                          <span class="font-semibold text-gray-900">Компримирование</span>
                          <p class="text-gray-600 text-sm">5 ГПА (2 Solar + 3 GE)</p>
                        </div>
                      </div>
                      <div class="flex items-start">
                        <div class="w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center text-xs font-bold mr-3 mt-0.5">6</div>
                        <div>
                          <span class="font-semibold text-gray-900">Охлаждение и транспортировка</span>
                          <p class="text-gray-600 text-sm">22 линии АВО-газа, выход по двум ниткам</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <section class="mb-10" v-if="station?.safetySystems && station.safetySystems.length > 0">
                <h4 class="text-xl font-bold text-gray-900 mb-6 pb-3 border-b-2 border-blue-600">
                  5. СИСТЕМЫ БЕЗОПАСНОСТИ И КОНТРОЛЯ
                </h4>
                
                <div class="space-y-3">
                  <div v-for="(system, index) in station?.safetySystems" :key="index"
                    ...
                    <div class="flex items-start">
                      ...
                      <div class="ml-4 flex-grow">
                        <div class="flex items-center justify-between mb-2">
                          <h5 class="font-bold text-gray-900 text-base">{{ system.name }}</h5>
                          <span v-if="system.manufacturer" class="text-xs bg-green-600 text-white px-3 py-1 rounded-full font-semibold">
                            {{ system.manufacturer }}
                          </span>
                        </div>
                        <p class="text-sm text-gray-700 mb-3 leading-relaxed">{{ system.description }}</p>
                        <div v-if="system.features && system.features.length > 0" class="flex flex-wrap gap-2">
                          <span v-for="(feature, fIdx) in system.features" :key="fIdx" 
              ...
              <div class="mt-12 pt-8 border-t-2 border-gray-300">
                <div class="flex justify-between items-end">
                  <div>
                    <div class="text-sm text-gray-600 mb-2">Документ действителен</div>
                    <div class="text-xs text-gray-500">Последнее обновление: {{ new Date().toLocaleDateString('ru-RU') }}</div>
                  </div>
                  <div class="text-right">
                    <div class="inline-block px-6 py-3 bg-blue-600 text-white rounded-lg">
                      <div class="text-xs opacity-90">Утверждено</div>
                      <div class="font-bold">СП ООО «ATG»</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="max-w-7xl mx-auto mb-12" v-if="station?.techMapImage">
          <div class="mb-8">
            ...
            <div class="h-1 w-24 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full"></div>
            <p class="text-gray-600 mt-4">Схема технологического процесса компрессорной станции {{ station?.shortName }}</p>
          </div>
          ...
          <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-gray-200">
            <div class="bg-gradient-to-r from-gray-800 to-gray-700 text-white px-6 py-4">
              <div class="flex items-center justify-between">
                <h3 class="text-lg font-bold">Process Flow Diagram - {{ station?.shortName }}</h3>
                <button 
              ...
              <div class="mt-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                <div class="flex">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-yellow-700 mt-1">Технологическая схема содержит конфиденциальную информацию. Использование только для учебных целей.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
          <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-2">Доступные тренинги</h2>
            <div class="h-1 w-24 bg-gradient-to-r from-blue-600 to-blue-400 rounded-full"></div>
          </div>
