    ...
    <div class="section-padding bg-gray-50 min-h-screen">
      <div class="page-container">
          ...
          <div class="card p-4 sm:p-6">
            <div class="flex items-center">
              <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                <el-icon :size="20" class="text-blue-600 sm:w-6 sm:h-6"><VideoPlay /></el-icon>
              </div>
              <div class="ml-3 sm:ml-4">
                <p class="text-xs sm:text-sm text-gray-600">{{ $t('dashboard.stats.activeCourses') }}</p>
                <p class="text-lg sm:text-2xl font-bold text-gray-900">{{ stats.activeCourses }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4 sm:p-6">
            <div class="flex items-center">
              <div class="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                <el-icon :size="20" class="text-orange-600 sm:w-6 sm:h-6"><Trophy /></el-icon>
              </div>
              <div class="ml-3 sm:ml-4">
                <p class="text-xs sm:text-sm text-gray-600">{{ $t('dashboard.stats.completedCourses') }}</p>
                <p class="text-lg sm:text-2xl font-bold text-gray-900">{{ stats.completedCourses }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4 sm:p-6">
            <div class="flex items-center">
              <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-200 rounded-lg flex items-center justify-center">
                <el-icon :size="20" class="text-blue-700 sm:w-6 sm:h-6"><Clock /></el-icon>
              </div>
              <div class="ml-3 sm:ml-4">
                <p class="text-xs sm:text-sm text-gray-600">{{ $t('dashboard.stats.hoursStudied') }}</p>
                <p class="text-lg sm:text-2xl font-bold text-gray-900">{{ stats.hoursStudied }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="card p-4 sm:p-6">
            <div class="flex items-center">
              <div class="w-10 h-10 sm:w-12 sm:h-12 bg-orange-200 rounded-lg flex items-center justify-center">
                <el-icon :size="20" class="text-orange-700 sm:w-6 sm:h-6"><Medal /></el-icon>
              </div>
              <div class="ml-3 sm:ml-4">
                <p class="text-xs sm:text-sm text-gray-600">{{ $t('dashboard.stats.certificates') }}</p>
                <p class="text-lg sm:text-2xl font-bold text-gray-900">{{ stats.certificates }}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="lg:col-span-2">
            <div class="card p-6">
              <div class="flex items-center justify-between mb-6">
                <h2 class="text-xl font-semibold text-gray-900">{{ $t('dashboard.activeCourses.title') }}</h2>
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600">{{ course.progress }}% {{ $t('dashboard.activeCourses.completed') }}</p>
                    <el-progress 
                  ...
                  <div class="text-right">
                    <el-button @click="$router.push(`/course/${course.id}`)" type="primary" size="small">
          ...
          <div class="lg:col-span-1">
            ...
            <div class="card p-6 mb-6">
              <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ $t('dashboard.activity.title') }}</h3>
              <div class="space-y-4">
                <div 
            ...
            <!-- Achievements -->
            <div class="card p-6">
              <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ $t('dashboard.achievements.title') }}</h3>
              <div class="space-y-4">
                <div 
        ...
        <div class="mt-8">
          <div class="card p-6">
            <div class="flex items-center justify-between mb-6">
              <h2 class="text-xl font-semibold text-gray-900">{{ $t('dashboard.recommended.title') }}</h2>
              <el-button @click="$router.push('/courses')" type="primary" plain>
