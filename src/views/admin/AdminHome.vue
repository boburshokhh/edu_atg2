  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Stations Card -->
        <div
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 cursor-pointer"
        ...
        >
          ...
          <div class="relative p-8">
            <div class="flex items-center justify-between mb-6">
              ...
              <svg
                class="w-6 h-6 text-gray-400 group-hover:text-blue-500 transition-colors duration-300 transform group-hover:translate-x-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        >
          ...
          <div class="relative p-8">
            <div class="flex items-center justify-between mb-6">
              ...
              <svg
                class="w-6 h-6 text-gray-400 group-hover:text-purple-500 transition-colors duration-300 transform group-hover:translate-x-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p class="text-gray-600 mb-4">
              Управление фоновыми изображениями для главной страницы. Загрузка нескольких фото для слайдера
            </p>
        ...
        >
          <div class="absolute inset-0 bg-gradient-to-br from-orange-500/5 to-amber-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <div class="relative p-8">
            <div class="flex items-center justify-between mb-6">
              <div class="w-16 h-16 bg-gradient-to-br from-orange-500 to-amber-500 rounded-xl flex items-center justify-center shadow-lg">
                <svg
                  class="w-8 h-8 text-white"
                  fill="none"
                  stroke="currentColor"
              ...
              <svg
                class="w-6 h-6 text-gray-400 group-hover:text-orange-500 transition-colors duration-300 transform group-hover:translate-x-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p class="text-gray-600 mb-4">
              Управление тестами уроков и финальными тестами. Создание вопросов и просмотр результатов
            </p>
        ...
        <div
          class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 cursor-pointer"
          @click="$router.push('/admin/tests/results')"
        >
          <div class="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
          <div class="relative p-8">
            <div class="flex items-center justify-between mb-6">
              <div class="w-16 h-16 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-xl flex items-center justify-center shadow-lg">
                <svg
                  class="w-8 h-8 text-white"
                  fill="none"
                  stroke="currentColor"
              ...
              <svg
                class="w-6 h-6 text-gray-400 group-hover:text-indigo-500 transition-colors duration-300 transform group-hover:translate-x-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            <p class="text-gray-600 mb-4">
              Просмотр всех результатов прохождения тестов пользователями
            </p>
        ...
        >
          ...
          <div class="relative p-8">
            <div class="flex items-center justify-between mb-6">
              <div class="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg">
                ...
                >
                  ...
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M17 21v-8a2 2 0 00-2-2H9a2 2 0 00-2 2v8"
                  />
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <svg
                class="w-6 h-6 text-gray-400 group-hover:text-green-500 transition-colors duration-300 transform group-hover:translate-x-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
