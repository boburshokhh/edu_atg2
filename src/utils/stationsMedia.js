/**
 * Helpers for resolving station media references (image, tech map) to either:
 * - absolute URL (http/https)
 * - public path (/stations/..., /tex_kart/...)
 * - MinIO object key (stations/..., tex_kart/...) for presigned URL generation
 */
...
/**
 * @param {string} raw
 * @param {{ defaultFolder: 'stations'|'tex_kart' }} opts
 * @returns {{
 ...
 * }}
 */
export function resolveStationMedia(raw, { defaultFolder }) {
