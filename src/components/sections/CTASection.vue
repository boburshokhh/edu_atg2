<template>
  <section class="relative section-padding overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
    <!-- Background Pattern -->
    <div class="section-pattern">
      <div class="absolute inset-0">
        <svg class="w-full h-full">
          <defs>
            <pattern id="blueprint-grid-cta" width="40" height="40" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#blueprint-grid-cta)"></rect>
        </svg>
      </div>
    </div>
