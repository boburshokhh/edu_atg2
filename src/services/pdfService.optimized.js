/**
 * Оптимизированный PDF.js Service с виртуализацией и кэшированием
 */
import * as pdfjsLib from 'pdfjs-dist'
import { LRUCache } from '@/utils/performance'

// Кэш для загруженных PDF документов
const documentCache = new LRUCache(10)
// Кэш для отрендеренных страниц
const pageCache = new LRUCache(50)
// Кэш для объектов страниц PDF
const pageObjectCache = new LRUCache(30)
...
export const renderPdfPage = async (page, canvas, scale = 2.0) => {
  ...
  // Проверяем кэш отрендеренной страницы
